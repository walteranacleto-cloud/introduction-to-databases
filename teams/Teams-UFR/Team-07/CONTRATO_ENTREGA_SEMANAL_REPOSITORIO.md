...
- **Equipe:** `team-07`
- **Semana / Sprint:** `01`
- **Período da entrega:** `23/08/2026 a 30/08/2026`
- **Issue da semana:** `#XX`
- **Branch da equipe:** `team-07-sprint-01`
- **Pull Request:** `#XX`
...
Criar um banco de dados atualizado da Raaei (Rondonópolis Associação de Atletismo e Esporte Inclusivo).
